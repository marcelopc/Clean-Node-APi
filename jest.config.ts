...
export default {
  ...
  // maxWorkers: 10% will
  // use 10% of your CPU amount + 1 as the maximum worker number.
  ...
  // A map from regular expressions to module
  // names or to arrays of module names that allow to stub out resources with a single module
  // moduleNameMapper: {},
  ...
  // test is considered as slow and reported as such in the results.
  // slowTestThreshold: 5,
  ...
  // matched against all source file paths, matched files will skip transformation
